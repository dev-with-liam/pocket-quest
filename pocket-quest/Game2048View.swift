...
struct Game2048View: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [
                    Color(red: 0.66, green: 0.96, blue: 0.70),
                    Color(red: 0.99, green: 0.79, blue: 0.38),
    ...
    private var scoreRow: some View {
        HStack(spacing: 10) {
            ...
            Score2048Tile(title: "Wins", value: viewModel.wins, tint: .purple)
            Score2048Tile(title: "Losses", value: viewModel.losses, tint: .red)
        }
        .frame(maxWidth: 420)
    }
    ...
    private var board: some View {
        ...
        .background(
            LinearGradient(
                colors: [.green.opacity(0.18), .yellow.opacity(0.16)],

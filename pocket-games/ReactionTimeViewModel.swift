...
final class ReactionTimeViewModel: ObservableObject {
    ...
    init(
        ...
        self.bestReactionMilliseconds = statsStore.optionalInteger(forKey: "stats.reactionTime.best")
        self.attempts = statsStore.integer(forKey: "stats.reactionTime.attempts")
    }
    ...
    func tapTarget() {
        ...
        case .tapNow:
            ...
            if let bestReactionMilliseconds {
                statsStore.set(bestReactionMilliseconds, forKey: "stats.reactionTime.best")
            }
            recordAttempt()
            phase = .result
    ...
    func resetBest() {
        ...
        statsStore.removeValue(forKey: "stats.reactionTime.best")
    }

    private func recordAttempt() {
        attempts += 1
        statsStore.set(attempts, forKey: "stats.reactionTime.attempts")
    }

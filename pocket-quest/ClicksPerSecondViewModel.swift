...
final class ClicksPerSecondViewModel: ObservableObject {
    ...
    init(duration: Double = 5, statsStore: GameStatsStore = GameStatsStore()) {
        self.duration = duration
        self.statsStore = statsStore
        self.remainingSeconds = duration
        self.bestClicksPerSecond = statsStore.double(forKey: "stats.clicksPerSecond.best")
        self.attempts = statsStore.integer(forKey: "stats.clicksPerSecond.attempts")
    }
    ...
    func resetBest() {
        ...
        statsStore.set(bestClicksPerSecond, forKey: "stats.clicksPerSecond.best")
    }
    ...
    private func tick() {
        ...
        if remainingSeconds == 0 {
            ...
            attempts += 1
            statsStore.set(bestClicksPerSecond, forKey: "stats.clicksPerSecond.best")
            statsStore.set(attempts, forKey: "stats.clicksPerSecond.attempts")
            timerTask?.cancel()
            timerTask = nil
        }
    }
